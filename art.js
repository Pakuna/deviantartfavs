...
if (oFavButton) {
    ...
    for (let i in aCollections) {
        ...
        const oFavText = oNewStar.querySelector("._2DN7K")
        ...
        // Clicks
        oNewStar.addEventListener("click", function() {
            fetch("https://www.deviantart.com/_puppy/dashared/collections/collect", {
                method: "POST",
                headers: {
	...
	setTimeout(function() {
        // Adding the stars above the picture
		document.querySelector("._2SlAD").before(oStarsContainer)
	}, 10)
}
